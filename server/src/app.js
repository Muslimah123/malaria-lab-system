...
class App {
  ...
  setupMiddleware() {
    ...
    // ✅ FIXED: Static file serving with correct Docker volume mount point
    const uploadsPath = process.env.UPLOAD_DIR || '/app/uploads';
    ...
    this.app.get('/api', (req, res) => {
      res.json({
        ...
        endpoints: {
          ...
          settings: '/api/settings' // ✅ ADDED: Settings endpoint
        },
        documentation: '/api-docs',
        version: '1.0.0'
      });
