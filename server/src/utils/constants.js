...
const FILE_SIZE_LIMITS = {
  ...
  MAX_FILES_PER_REQUEST: 50,  // Increased for hospital use
...
const AUDIT_ACTIONS = {
  ...
  UPLOAD_SESSION_CANCELLED: 'upload_session_cancelled',
...
DIAGNOSIS_FAST_MODE: 'diagnosis_fast_mode',
DIAGNOSIS_ENHANCED_MODE: 'diagnosis_enhanced_mode',
DIAGNOSIS_URGENT_CASE: 'diagnosis_urgent_case',
DIAGNOSIS_FALLBACK_ATTEMPT: 'diagnosis_fallback_attempt',  // ✅ NEW: Fallback tracking
DIAGNOSIS_FALLBACK_SUCCESS: 'diagnosis_fallback_success',  // ✅ NEW: Fallback success
DIAGNOSIS_FALLBACK_FAILED: 'diagnosis_fallback_failed',   // ✅ NEW: Fallback failure
  ...
  BULK_REPORT_GENERATED: 'bulk_report_generated',
...
const FLASK_API_CONFIG = {
  ...
  //   MULTI_FORMAT_BBOX: 'multi_format_bbox'
  // },
  // Processing modes
  PROCESSING_MODES: {
    ENHANCED: 'enhanced',
    FAST: 'fast',
    FAST_FALLBACK: 'fast_fallback',  // ✅ NEW: Fallback mode
    BOTH_MODES_FAILED: 'both_modes_failed'  // ✅ NEW: Complete failure
  }
};
...
DIAGNOSIS_MODE_CHANGED: 'diagnosis:mode_changed',
DIAGNOSIS_FEATURES_USED: 'diagnosis:features_used',
DIAGNOSIS_FALLBACK_STARTED: 'diagnosis:fallback_started',  // ✅ NEW: Fallback started
DIAGNOSIS_FALLBACK_COMPLETED: 'diagnosis:fallback_completed',  // ✅ NEW: Fallback completed
...
const DETECTION_CONSTANTS = {
  ...
  SUPPORTED_PARASITE_TYPES: ['PF', 'PM', 'PO', 'PV'],
  SUPPORTED_WBC_TYPES: ['WBC'],
  BBOX_FORMAT: 'xyxy', // Only basic bbox format supported
