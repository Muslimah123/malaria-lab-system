...
import ParasiteTable from '../components/results/ParasiteTable';
...
const TestResultsPage = () => {
  ...
  const isPositive = testResult.status === 'POS';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <DiagnosisCard result={testResult} />
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ImageAnnotation images={images} />

            {/* Parasite Detection Table */}
            {testResult.detections && testResult.detections.length > 0 && (
              <ParasiteTable detections={testResult.detections} />
            )}
...
<div>
  ...
  <div className="bg-white/5 backdrop-blur-md rounded-lg p-4 border border-white/10">
    <p className="text-blue-100">
      {isPositive 
        ? `Positive for malaria. ${getParasiteFullName(parasiteType)} detected with ${testResult.confidence.toFixed(1)}% confidence. ${severity ? `Parasite density indicates ${severity.toLowerCase()} infection.` : ''}`
        : 'No malaria parasites detected in the analyzed blood smear samples.'
      }
    </p>
  </div>
</div>
                  ...
                  <div className="bg-white/5 backdrop-blur-md rounded-lg p-4 border border-white/10">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <span className="text-white ml-2">{testResult.totalImagesAnalyzed || 0}</span>
                      </div>
                      <div>
                        <span className="text-blue-200">Quality Score:</span>
                      ...
                      {testResult.manualReview?.isReviewed && (
                        <>
                          <div>
                            <span className="text-blue-200">Manual Review:</span>
                            <span className="text-green-300 ml-2">Completed</span>
                          </div>
                          <div>
                            <span className="text-blue-200">Reviewer:</span>
                            <span className="text-white ml-2">
                              {testResult.manualReview.reviewedBy?.firstName} {testResult.manualReview.reviewedBy?.lastName}
                            </span>
                          </div>
                        </>
                      )}
                    ...
                    <div className="bg-purple-500/20 border border-purple-500/30 rounded-lg p-4">
                      ...
                      {testResult.manualReview.overriddenStatus && (
                        <div className="mt-2 text-sm">
                          <span className="text-purple-200">Final Status: </span>
