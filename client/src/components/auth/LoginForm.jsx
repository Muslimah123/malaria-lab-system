...
const LoginForm = () => {
  ...
  // Check for time-based reset of login attempts
  useEffect(() => {
    const checkLoginAttemptsReset = () => {
      ...
      if (stored && lockoutTime) {
        ...
        const timeElapsed = now - lockoutTimestamp;
        ...
        if (timeElapsed > fifteenMinutes) {
          ...
          const remaining = fifteenMinutes - timeElapsed;
    ...
    // Check immediately
    checkLoginAttemptsReset();
    
    // Check every second for countdown
    const interval = setInterval(checkLoginAttemptsReset, 1000);
                      ...
                      <div>
                        ...
                        {timeRemaining ? (
                          <p className="text-amber-200/80 text-xs">
                            Please wait {timeRemaining.minutes}:{timeRemaining.seconds.toString().padStart(2, '0')} or contact support
                          </p>
                        ) : (
