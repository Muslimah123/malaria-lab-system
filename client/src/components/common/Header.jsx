...
const Header = ({ 
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-white/10 backdrop-blur-md border-b border-white/20 lg:left-64 transition-all duration-300">
            ...
            <div className="relative">
              ...
              {showUserDropdown && (
                <>
                  ...
                  />
                  <div className="fixed right-4 top-20 w-48 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg shadow-lg z-[60]">
                    <div className="p-2">
