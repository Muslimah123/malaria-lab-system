...
const PatientForm = ({ 
  ...
  const handleFormSubmit = (data) => {
    console.log('📝 Form submission data:', { data, isNewPatient });
    
    // ✅ FIXED: Transform form data to match backend Patient model structure
    const patientData = {
      // Basic information - don't include patientId for new patients
      ...(isNewPatient ? {} : { patientId: data.patientId || undefined }),
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                {...register('patientId', {
                  // ✅ FIXED: Only require Patient ID for existing patients
                  ...(isNewPatient ? {} : {
